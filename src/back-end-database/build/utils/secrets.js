...
exports.STRIPE_KEY = process.env["STRIPE_PUBLISHABLE_KEY"] ? process.env["STRIPE_PUBLISHABLE_KEY"] : "";
...
if (!process.env["STRIPE_PUBLISHABLE_KEY"]) {
    logger_1.default.error("No stripe key string. Set STRIPE_PUBLISHABLE_KEY environment variable.");
    process.exit(1);
}
